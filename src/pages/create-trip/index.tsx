...
export function CreateTripPage() {
    ...
    const [emailsToInvite, setEmailsToInvite] = useState(["enzo@gmail.com.br"]);
    ...
    function openGuestsModal() {
        setIsGuestsModalOpen((modal) => !modal);
    }
                ...
                <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
                    <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                        ...
                        <button
                            ...
                            type='submit'
                            className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium gap-2 hover:bg-lime-400 transition items-center justify-between w-full'>
                            Finalizar
                        </button>
                    </div>
                </div>
