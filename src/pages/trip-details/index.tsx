...
export function TripDetailsPage() {
    const [isCreateCactivityModalOpen, setIsCreateActivityModalOpen] = useState(false);
                ...
                <div className='w-80 space-y-6'>
                        ...
                        <div className='space-y-5'>
                            <div className='flex items-center justify-between gap-4'>
                                <div className='space-y-1.5'>
                                    ...
                                    <a href='#' className='block text-xs text-zinc-400 truncate hover:text-zinc-200'>
                                        https://www.airbnb.com.br/rooms/10470001121312312312312
                                    </a>
                                </div>
                            ...
                            <div className='flex items-center justify-between gap-4'>
                                <div className='space-y-1.5'>
                                    ...
                                    <a href='#' className='block text-xs text-zinc-400 truncate hover:text-zinc-200'>
                                        https://trello.com/b/Sz17MnUo/metas-e-afazeres
                                    </a>
                                </div>
                                <Link2 className='text-zinc-400 size-5 shrink-0' />
                            </div>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='space-y-5'>
                            <div className='flex items-center justify-between gap-4'>
                                <div className='space-y-1.5'>
                                    <span className='block font-medium text-zinc-100'>Jessica Hoffman</span>
                            ...
                            <div className='flex items-center justify-between gap-4'>
                                <div className='space-y-1.5'>
                                    <span className='block font-medium text-zinc-100'>Dra. Cássia Nobre</span>
                                    <span className='block text-sm text-zinc-400 truncate hover:text-zinc-200'>
                                        cassia@nobre.com
                                    </span>
                                </div>
                ...
                <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
                    <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                        ...
                        <form className='space-y-3'>
                            ...
                            <button
                                type='submit'
                                className='bg-lime-300 w-full justify-center text-lime-950 rounded-lg px-5 h-11 font-medium flex items-center gap-2 hover:bg-lime-400 transition'>
                                Salvar atividade
                                <Plus className='size-5' />
                            </button>
                        </form>
